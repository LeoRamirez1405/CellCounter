...
2.	Diluir las células según sea necesario para obtener una suspensión uniforme. Dispersar cualquier grumo.
          ...
          """,
            ...
            const TextHelper(
              ...
              body: Text(
                """Se realiza una mezcla con suspensión de células que sea equivalente 1:1 a la solución de azul de tripán 0.4%, se toma 10-15 μL de la solución y se lleva a la cámara de Neubauer previa limpieza de este instrumento con etanol al 70%, luego examinar con un microscopio. 
                La cámara de Neubauer está delineada por líneas de cuadrícula que identifican las zonas de la cámara, con cuatro zonas que están divididas por 16 cuadrados pequeños Se realiza el recuento del número de células viables (sin teñir) y no viables (teñidas), en cada una de las 4 zonas.
          """,
                textAlign: TextAlign.justify,
              ),
            ),
